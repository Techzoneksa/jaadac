...
export default function DebitNoteDetailPage() {
  ...
  return (
    <div>
      <PageHeader title={`إشعار مدين #${dn.number}`} description={`تاريخ: ${dn.date}`}
        action={<div className="flex gap-2"><Button variant="outline" onClick={() => router.push(`/purchases/debit-notes/${params.id}/print`)}>طباعة</Button><Button variant="outline" onClick={() => router.back()}>رجوع</Button></div>} />
      <Card>
