...
interface Props {
  ...
  onCreated: (c: { id: string; name_ar: string }) => void;
}

export function QuickAddCustomer({ open, onOpenChange, onCreated }: Props) {
  ...
  async function handleSave() {
    ...
    setSaving(false);
    if (!res.ok) { setErr(json.error || "فشل إنشاء العميل"); return; }
