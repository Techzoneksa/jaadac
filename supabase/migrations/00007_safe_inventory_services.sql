-- JAAD CLOUD — Inventory & Services Module (Idempotent version)
-- Safe to re-run. All policies guarded with IF NOT EXISTS.
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_branches' AND policyname = 'Users can manage own inventory_branches') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_categories' AND policyname = 'Users can manage own inventory_categories') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'service_categories' AND policyname = 'Users can manage own service_categories') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_movements' AND policyname = 'Users can manage own inventory_movements') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_counts' AND policyname = 'Users can manage own inventory_counts') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_count_lines' AND policyname = 'Users can manage own inventory_count_lines') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'manufacturing_cards' AND policyname = 'Users can manage own manufacturing_cards') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'manufacturing_card_lines' AND policyname = 'Users can manage own manufacturing_card_lines') THEN
