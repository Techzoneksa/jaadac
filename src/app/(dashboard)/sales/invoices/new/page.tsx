...
export default function NewSalesInvoicePage() {
    ...
    setLines(lines.map((l) => {
      ...
      if (field === "item_id") {
        ...
        if (item) {
          ...
          updated.unit_price = item.sales_price;
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!customerId) { setError("الرجاء اختيار العميل"); return; }
  ...
  return (
    <div>
      <PageHeader title="فاتورة مبيعات جديدة" description="إنشاء فاتورة مبيعات"
