...
-- DOCUMENTATION ONLY (superseded by Phase 2.1.1).
-- Runnable source of truth: supabase/migrations/20260611120007_chart_account_purposes_readiness.sql
-- This planned copy is retained for review / diffing.
