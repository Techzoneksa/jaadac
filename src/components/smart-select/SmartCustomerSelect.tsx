...
export function SmartCustomerSelect({
  ...
  return (
    <SmartEntityCombobox<Customer>
      value={value} onChange={handle} fetcher={fetcher} resolveLabel={resolveLabel}
      placeholder={t("smart_search_customer")} searchPlaceholder={t("smart_search_customer")}
      emptyText={t("smart_no_results")} suggestionsHeader={t("smart_recent_customers")}
